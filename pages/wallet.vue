                ...
                <div class="elementor-container elementor-column-gap-no">
                    <div class="elementor-column elementor-col-100 elementor-top-column elementor-element elementor-element-0cb4be0"
                        ...
                        <div class="elementor-widget-wrap elementor-element-populated">
                            <div class="elementor-element elementor-element-dfbdb59 elementor-widget elementor-widget-crypto_live_price"
                                data-id="dfbdb59" data-element_type="widget" data-widget_type="crypto_live_price.default">
                                <div class="elementor-widget-container">

                                    <div id="cr-live-market" class="cr-live-market-section position-relative">
                                        <span class="cr-shape1 position-absolute"><img
                                                src="~/assets/uploads/sites/59/2022/03/sh4.png" alt=""></span>
                                        <span class="cr-shape2 position-absolute"><img
                                                src="~/assets/uploads/sites/59/2022/03/sh2-1.png" alt=""></span>
                                        <span class="cr-shape3 position-absolute"><img
                                                src="~/assets/uploads/sites/59/2022/03/st2.png" alt=""></span>
                                        <div class="container crypto-container-1200">
                                            <div class="cr-section-title cr-headline text-center wow fadeFromUp"
                                                data-wow-delay="0ms" data-wow-duration="1500ms">
                                                <!-- <span>Select Your Wallet To begin 🖐</span> -->
                                                <h2>Select Your Wallet To begin</h2>
                                                <p> Multiple iOS and Android wallets support the VarroWalletConnect protocol. Interaction between mobile apps and mobile browsers are supported via mobile deep linking.</p>
                                            </div>
                                            <div class="cr-live-market-content position-relative">
                                                <span class="cr-shape4 position-absolute"><img
                                                        src="~/assets/uploads/sites/59/2022/03/st2.png" alt=""></span>
